    ...
    var t = function () {}, e = function () {
        ...
        $(".createvideo").on("click", function () {
            ...
            if (n && 11 == n[1].length) t = '<iframe src="//www.youtube.com/embed/' + n[1] + '" width="100%" height="400" frameborder="0" allowfullscreen></iframe>', a = "http://img.youtube.com/vi/" + n[1] + "/hqdefault.jpg", o(a), e = t;
                ...
                t = '<div id="' + u + '" class="fb-video" data-href="' + i + '" style="max-height: 360px;"><div class="fb-xfbml-parse-ignore"></div></div><script>(typeof FB != "undefined") && FB.XFBML.parse($("#' + u + '").parent()[0]);</script>', a = "https://graph.facebook.com/" + l[1] + "/picture?type=large", o(a), e = i
            }
            d($(this), t, e)
        })
    }, d = function (t, e, a) {
        ...
        $(".PostAction").off("click").on("click", function () {
            ...
            $(".entry").each(function (e, a) {
                ...
                if ((null == typeof l || "" == l || void 0 == l) && (l = null), "quizquestion" == i) {
                    ...
                    (null == typeof d || "" == d || void 0 == d) && (d = null), t[e] = {
                        ...
                        (null == typeof s || "" == s || void 0 == s) && (s = null), t[e].answers[a] = {
                            type: n,
                            title: o,
                            image: r,
                            assign: s
                    ...
                    (null == typeof d || "" == d || void 0 == d) && (d = null), t[e] = {
                        ...
                        (null == typeof o || "" == o || void 0 == o) && (o = null);
                        var r = $(this).find('[data-type="image"]').first().val();
                        (null == typeof r || "" == r || void 0 == r) && (r = null), t[e].answers[a] = {
                            type: n,
                            title: o,
                            image: r,
                            assign: "1"
            ...
            var e = $(this).closest("form"),
                ...
                l = e.find("#tags").val(),
                d = e.find("select[name=category]").val(),
                u = e.find("select[name=pagination]").val(),
                c = e.find("input[name=thumb]").val(),
                p = e.find(".lists-types a.selected").attr("data-order");
            return (null == typeof p || "" == p || void 0 == p) && (p = null), $(".lists-types").length > 0 && 0 == $(".lists-types a.selected").length ? (swal("Cooise list type"), NProgress.done(!0), App.initLoadingCaption("hide"), !1) : $(".entry").length < parseInt(u) && 0 != u ? (swal(BuzzyEditorlang.lang_12), NProgress.done(!0), App.initLoadingCaption("hide"), !1) : void $.post(n, {
                datapostt: a,
                title: r,
                description: s,
                tags: l,
