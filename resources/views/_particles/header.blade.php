<header id="punica-page-header">
    ...
    <div class="sticky-wrapper" style="height: 70px;">
        <div id="header-middle" class="clearfix fixed">
                ...
                <nav id="main-nav" class="pull-left">
                    ...
                    <ul id="main-menu" class="clearfix sf-js-enabled">
                        ...
                        <li>
                            ...
                            <ul style="display: none;">
                                <li>
                                    <a href="#" class="sf-with-ul">Categories page</a>
                                    <ul style="display: none;">
                                        <li>
                                            <a href="category-1.html">Category style 1</a>
                                        </li>
                                        <li>
                                            <a href="category-2.html">Category style 2</a>
                                        </li>
                                        <li>
                                            <a href="category-3.html">Category style 3</a>
                                        </li>
                                        <li>
                                            <a href="category-4.html">Category style 4</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul style="display: none;">
                                        <li>
                                            <a href="single.html">Standard post</a>
                                        </li>
                                        <li>
                        ...
                        <li>
                            <a href="single.html" class="sf-with-ul">Single page</a>
                            <ul style="display: none;">
                                <li>
                                    <a href="single.html">Standard post</a>
                                </li>
                        ...
                        <li>
                            <a href="elements.html">Shortcode</a>
                        </li>
                        <li>
                        ...
                        <li class="mega-menu">
                            <a href="#" class="sf-with-ul">Mega menu</a>
                            <div class="sf-mega sf-mega-s1" style="display: none;">
                                <div class="row">
                        ...
                        <ul id="mobile-menu">
                            ...
                            <li>
                                ...
                                <ul data-index="1" style="display: none;">
                                    <li>
                                        <a href="category-1.html">Category page style 1</a>
                                    </li>
                                    <li>
                                        <a href="category-2.html">Category page style 2</a>
                                    </li>
                                    <li>
                                        <a href="category-3.html">Category page style 3</a>
                                    </li>
                                    <li>
                                        <a href="category-4.html">Category page style 4</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul data-index="4" style="display: none;">
                                    <li>
        ...
        <div class="wrapper clearfix">
            ...
            <nav id="secondary" class="pull-left">
                <ul id="secondary-menu" class="pull-left clearfix">
                    ...
                    <li>
                        <a href="#">Picture off the week</a>
                    </li>
                    <li>
                        <a href="#">Also in the news</a>
                    </li>
                    <li>
                        <a href="#">Editors'Blogs </a>
                    </li>
                    <li>
