...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2017 <a href="http://techstar.cloud" target="_blank">Techstar, Inc.</a>.</strong> All rights reserved.
        </div>
        <b><a href="http://techstar.cloud" target="_blank">Techstar CMS</a></b> Version : {{ Config::get('installer.last_version') }}
    </footer>
